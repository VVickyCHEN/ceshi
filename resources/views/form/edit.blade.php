...
<head>
    <title>
      网页组件_大气漂亮的Bootstrap后台管理系统模板Se7en - jq22
    </title>
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-lg-12">
                <div class="widget-container">
                  <div class="heading">
                    <i class="icon-spinner"></i>Progress bars
                  </div>
              ...
              <div class="col-lg-12">
                <div class="widget-container fluid-height">
                  <div class="heading tabs">
                    <i class="icon-sitemap"></i>Tabs  
                    <ul class="nav nav-tabs pull-right" data-tabs="tabs" id="tabs">
                      <li class="active">
                        <a data-toggle="tab" href="#tab1"><i class="icon-comments"></i><span>Comments</span></a>
                      </li>
                      <li>
                        <a data-toggle="tab" href="#tab2"><i class="icon-user"></i><span>Profile</span></a>
                      </li>
                      <li>
                        <a data-toggle="tab" href="#tab3"><i class="icon-paper-clip"></i><span>Attachments</span></a>
                      </li>
                    </ul>
                  </div>
            ...
            <div class="row">
              <div class="clearfix">
                <div class="col-lg-6">
                  <div class="widget-container fluid-height">
                    <div class="heading">
                      <i class="icon-question"></i>Tooltip
                    </div>
                    <div class="widget-content padded text-center">
                      <a class="btn btn btn-default" data-toggle="tooltip" id="tooltip-top" style="width:45%" title="Tooltip content">Top </a><br><a class="btn btn btn-default" data-toggle="tooltip-right" id="tooltip-right" style="width:45%" title="Tooltip content">Right</a><a class="btn btn btn-default" data-toggle="tooltip-left" id="tooltip-left" style="width:45%" title="Tooltip content">Left</a><a class="btn btn btn-default" data-toggle="tooltip-bottom" id="tooltip-bottom" style="width:45%" title="Tooltip content">Bottom</a>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="widget-container fluid-height">
                    <div class="heading">
                      <i class="icon-comment"></i>Popover
                    </div>
                    <div class="widget-content padded text-center">
                      <a class="btn btn btn-default" data-content="And here's some amazing content. It's very engaging. right?" data-original-title="A Title" data-toggle="popover-top" id="popover-top" style="width:45%" title="">Top </a><br><a class="btn btn btn-default" data-content="And here's some amazing content. It's very engaging. right?" data-original-title="A Title" data-toggle="popover-right" id="popover-right" style="width:45%" title="">Right</a><a class="btn btn btn-default" data-content="And here's some amazing content. It's very engaging. right?" data-original-title="A Title" data-toggle="popover-left" id="popover-left" style="width:45%" title="">Left</a><a class="btn btn btn-default" data-content="And here's some amazing content. It's very engaging. right?" data-original-title="A Title" data-toggle="popover-bottom" id="popover-bottom" style="width:45%" title="">Bottom  </a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="widget-container fluid-height">
                  <div class="heading">
                    <i class="icon-fullscreen"></i>Modal
                  </div>
                  <div class="widget-content padded text-center">
                    <a class="btn btn-primary btn" data-toggle="modal" href="#myModal">Bootstrap Modal</a><a class="btn btn-default btn fancybox" href="#fancybox-example">Fancybox Modal</a>
                  </div>
                </div>
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-lg-12">
                <div class="widget-container fluid-height">
                  <div class="heading">
                    <i class="icon-warning-sign"></i>Sliders
                  </div>
                  <div class="widget-content padded">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="widget-container">
                  <div class="heading">
                    <i class="icon-warning-sign"></i>Alerts and Badges
                  </div>
                  <div class="widget-content padded">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="widget-container fluid-height">
                  <div class="heading">
                    <i class="icon-collapse"></i>Accordion
                  </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="widget-container fluid-height">
                  <div class="heading">
                    <i class="icon-book"></i>Pagination
                  </div>
                  <div class="widget-content padded text-center">
